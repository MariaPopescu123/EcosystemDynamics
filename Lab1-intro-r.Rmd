...
**Answer 4:**
It combines values into a vector or a list. 
...
```{r}
#Insert code for the answer to question seven here
b[7, 5] <- 100
b
...
```{r}
#insert answer to question 9 here
veg
...
**Answer 14: **
Though not exactly approximately over the course of 200 years (because the mortality rate is .02) it makes sense that the tree died and grew about 4 times (because the probably of the year being the year it dies is 1 in 50). Because there is some randomization it will not be exactly every 50 years that it dies. 
